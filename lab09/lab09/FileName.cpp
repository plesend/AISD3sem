...
// Функция скрещивания
void cross(string parent1, string parent2, string& newchild1, string& newchild2)
{
...
int main() {
    ...
    int population, crosses, evolves;
    ...
    for (int evolve = 0; evolve < evolves; evolve++) {
        ...
        for (int j = 0; j < crosses; j++) {
            ...
            cross(startpopulation[parent1Index], startpopulation[parent2Index], child1, child2);
        ...
        deleteWorstOnes(startpopulation, fitness.data(), crosses);
    }
